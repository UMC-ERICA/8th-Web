import { MovieCredit, MovieDetailResponce} from '../types/movie'


interface MovieContentProps {
    movie: MovieDetailResponce;
    credits: MovieCredit;
}
    ...
    return (
        <div className='max-w-screen-xl mx-auto'>
            <div className='relative'>
                <img 
                    src={`${import.meta.env.VITE_TMBD_IMAGE_BASE_URL}/w500${movie.backdrop_path}`}
                            ...
                            {credits?.cast?.slice(0,5).map((cast) => (
                                <li key={cast.cast_id} className='text-gray-600 mb-2'>
                                    <div className='flex items-conter gap-4'>
                                        {cast.profile_path && (
                                            <img
                                                src={`${import.meta.env.VITE_TMBD_IMAGE_BASE_URL}/w45${cast.profile_path}`}
                                                alt={cast.name}
